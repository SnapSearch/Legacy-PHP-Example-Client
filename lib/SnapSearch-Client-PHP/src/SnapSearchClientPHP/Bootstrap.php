...
class Bootstrap{
    ...
    public static function register(){
        ...
        spl_autoload_register(array('\SnapSearchClientPHP\Bootstrap', 'autoload_http_foundation'));

    }

    public static function autoload_http_foundation($class){

        //path to src folder, this only works with PSR-0
        $src_path = dirname(__DIR__) . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR;
